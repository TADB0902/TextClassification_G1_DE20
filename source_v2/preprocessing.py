...
def preprocess_page():
    ...
    if external_content and execute_button_external:
        ...
        # Tiền xử lý dữ liệu
        processed_external_content = text_preprocess(external_content.getvalue().decode("utf-8"))
    ...
    if execute_button_all_files:
        if not os.path.exists(input_file + sep + "data.pkl"):
            ...
            file = open(input_file + sep + "data.pkl", 'wb')
            ...
            #
            file = open(input_file + sep + "data.pkl", 'rb')
